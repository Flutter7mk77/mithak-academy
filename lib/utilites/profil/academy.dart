      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          ...
          children: List.generate(
            selectedCategoryListd.length,
            (index) => productCard(
              context,
              selectedCategoryListd[index]["image"],
              selectedCategoryListd[index]["label"],
              selectedCategoryListd[index]["price"],
              selectedCategoryListd[index]["details"],
            ),
          ),
        ),
      ),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    StoreDetailPage(image, label, price, details)));
      },
      child: Hero(
        tag: image,
        child: Expanded(
